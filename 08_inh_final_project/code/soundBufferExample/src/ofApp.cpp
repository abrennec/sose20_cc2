...
void ofApp::setup(){
    ...
    // NOTE: Define that this ofApp will play back the generated audio
...
void ofApp::update(){
    ...
    // NOTE: This lock ensures that no variables (i.e. the corresponding memory)
    // used inside of this block are being accessed
...
void ofApp::audioOut(ofSoundBuffer &outBuffer) {
	...
	for(size_t i = 0; i < outBuffer.getNumFrames(); i++) {
        ...
        // -----------
        // NOTE: Check and understand getSample( ... )
        // Question: How could the following code be improved?
